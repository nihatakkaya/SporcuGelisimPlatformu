        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentWordId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MotivationWords_MotivationWords_ParentWordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SportBranches_SportBranches_ParentBranchId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SportBranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssignedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordBranches", x => new { x.MotivationWordId, x.SportBranchId });
                    table.ForeignKey(
                        name: "FK_WordBranches_MotivationWords_MotivationWordId",
                        column: x => x.MotivationWordId,
                        principalTable: "MotivationWords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WordBranches_SportBranches_SportBranchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AthleteProfiles_SportBranches_PrimaryBranchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileAssets_AspNetUsers_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteRelations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AthleteRelations_AspNetUsers_RelatedUserId",
                        column: x => x.RelatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AthleteRelations_AthleteProfiles_AthleteProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AthleteSessions_AthleteProfiles_AthleteProfileId",
                        column: x => x.AthleteProfileId,
                        principalTable: "AthleteProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_AthleteProfiles_AthleteProfileId",
                        column: x => x.AthleteProfileId,
                        principalTable: "AthleteProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_AthleteSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedByRole = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    SelectionSource = table.Column<int>(type: "int", nullable: false),
                    CopiedFromSessionWordId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    WordTextSnapshot = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionWords_AthleteSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "AthleteSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionWords_MotivationWords_MotivationWordId",
                        column: x => x.MotivationWordId,
                        principalTable: "MotivationWords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SessionWords_SessionWords_CopiedFromSessionWordId",
                        column: x => x.CopiedFromSessionWordId,
                        principalTable: "SessionWords",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteProfiles_PrimaryBranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteRelations_AthleteProfileId_RelatedUserId_RelationType_IsActive",
                table: "AthleteRelations",
                columns: new[] { "AthleteProfileId", "RelatedUserId", "RelationType", "IsActive" },
                unique: true,
                filter: "[IsActive] = 1 AND [IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_AthleteRelations_RelatedUserId",
                table: "AthleteRelations",
                column: "RelatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AthleteSessions_AthleteProfileId_SessionNumber",
                table: "AthleteSessions",
                columns: new[] { "AthleteProfileId", "SessionNumber" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_AthleteProfileId",
                table: "Feedbacks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MotivationWords_NormalizedText",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MotivationWords_ParentWordId",
                table: "MotivationWords",
                column: "ParentWordId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionWords_CopiedFromSessionWordId",
                table: "SessionWords",
                column: "CopiedFromSessionWordId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionWords_MotivationWordId",
                table: "SessionWords",
                column: "MotivationWordId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionWords_SessionId_MotivationWordId",
                table: "SessionWords",
                columns: new[] { "SessionId", "MotivationWordId" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_SportBranches_ParentBranchId_Name",
                table: "SportBranches",
                columns: new[] { "ParentBranchId", "Name" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_WordBranches_SportBranchId",
                table: "WordBranches",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_FileAssets_ProfilePhotoId",
                table: "AspNetUsers",
                column: "ProfilePhotoId",
